from FlightFarePredictor.entity import artifact_entity,config_entity
...
import os,sys 
import pandas as pd
from FlightFarePredictor import utils
import numpy as np
from FlightFarePredictor.config import TARGET_COLUMN
...
class DataValidation:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            utils.write_yaml_file(file_path=self.data_validation_config.report_file_path,validation_data=self.validation_error)
